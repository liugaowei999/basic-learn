...
public class Diff {
    ...
    public static void getDiff() throws InterruptedException {
        ...
        System.out.println("数组数据构建耗时:" + (System.nanoTime() - begin) / 500000 + "ms");
    ...
    public static void getDiff2() throws InterruptedException {
        ...
        System.out.println("TreeSet数据构建耗时:" + (System.nanoTime() - begin) / 1000000 + "ms");
    ...
    public static void getDiff3() throws InterruptedException {
        ...
        System.out.println("HashSet数据构建耗时:" + (System.nanoTime() - begin) / 1000000 + "ms");
    ...
    public static void getDiff4() throws InterruptedException {
        ...
        System.out.println("LinkedHashSet数据构建耗时:" + (System.nanoTime() - begin) / 1000000 + "ms");
    ...
    public static void getDiff5() throws InterruptedException {
        ...
        System.out.println("HashMap数据构建耗时:" + (System.nanoTime() - begin) / 1000000 + "ms");
        for (int i = 0; i < SIZE; i++) {
