...
import mongodb.original.entity.Address;
import mongodb.original.entity.Favorites;
import mongodb.original.entity.User;

//spring Pojo的操作方式
@RunWith(SpringJUnit4ClassRunner.class)
@ContextConfiguration("classpath:applicationContextMongodb.xml")
public class QuickStartSpringPojoTest {
    ...
    public void testDelete() {
        ...
        WriteResult remove2 = tempelate
                .remove(query(new Criteria().andOperator(where("age").gt(8), where("age").lt(25))), User.class);
    ...
    public void testUpdate() {
        ...
        WriteResult updateFirst = tempelate.updateMulti(query(where("username").is("lison")), update("age", 6),
                User.class);
